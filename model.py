...
def FCN_Handnet(imgsize = 96, acc_range = 3):
    ...
    feature_network = tl.layers.Conv2d(feature_network, 128, (5,5), (1,1), act=tf.nn.relu, name='conv3')
    ...
    stage1 = tl.layers.Conv2d(stage1, 64, (9,9), (1,1), act=tf.nn.relu, name='stage1_conv1')
    stage1 = tl.layers.Conv2d(stage1, 32, (9,9), (1,1), act=tf.nn.relu, name='stage1_conv2')
    ...
    stage2 = tl.layers.Conv2d(stage2, 64, (9,9), (1,1), act=tf.nn.relu, name='stage2_conv1')
    stage2 = tl.layers.Conv2d(stage2, 32, (9,9), (1,1), act=tf.nn.relu, name='stage2_conv2')
    ...
    stage3 = tl.layers.Conv2d(stage3, 64, (9,9), (1,1), act=tf.nn.relu, name='stage3_conv1')
    stage3 = tl.layers.Conv2d(stage3, 32, (9,9), (1,1), act=tf.nn.relu, name='stage3_conv2')
    ...
    # label_reshape = tf.reshape(label, [-1, imgsize ** 2, 6])
    # stage1_reshape = tf.reshape(stage1_output, [-1, imgsize ** 2, 6])
    # stage2_reshape = tf.reshape(stage2_output, [-1, imgsize ** 2, 6])
    # stage3_reshape = tf.reshape(stage3_output, [-1, imgsize ** 2, 6])
    ...
    return train_op, img, label, stage1_loss, stage2_loss, stage3_loss, stage1_acc, stage2_acc, stage3_acc
